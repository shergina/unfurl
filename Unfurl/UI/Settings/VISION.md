...
Unfurl stays a lightweight menu-bar agent, but gains a face. A new
...
1. Welcome. A few words about what Unfurl is, plus the privacy
   statement: runs 100 percent on your Mac, the camera never leaves the
   device.
2. Tutorial. A button that points out Unfurl in the menu bar (flash
