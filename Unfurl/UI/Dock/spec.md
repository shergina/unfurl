...
- **Related code**: `.spec/app.spec.md`; `Unfurl/Tools/spec.md` (`attachOutput` on the shared session); `Unfurl/SRSettings.swift` (`showCameraOnDockTile`, `flipCameraHorizontally`).
