...
- The panel opens at 600x400 on a first run (`SRSettings.cameraPanelSize`, doubled from 300x200 on 2026-08-29: the old default read as a thumbnail rather than a mirror). Only the default moved - a dragged size still wins, and `minSize` stays 90x60.
